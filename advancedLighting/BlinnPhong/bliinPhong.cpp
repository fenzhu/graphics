...
int main(int argc, char *argv[])
{
    ...
    Shader modelShader = Shader("E:/Glitter/Glitter/Shaders/blinnPhong.vert",
                                "E:/Glitter/Glitter/Shaders/blinnPhong.frag");
    modelShader.setInt("texture1", 0);

    unsigned int floorTexture = loadTexture("E:/Glitter/assets/wood.png");
