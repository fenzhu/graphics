...
int main(int argc, char *argv[])
{
    ...
    auto mWindow = glfwCreateWindow(mWidth, mHeight, "AdvancedOpenGL", nullptr, nullptr);
    ...
    Shader singleColorShader = Shader("E:/Glitter/Glitter/Shaders/cube.vert",
                                      "E:/Glitter/Glitter/Shaders/singleColor.frag");
    ...
    while (glfwWindowShouldClose(mWindow) == false)
    {
        ...
        // when the fragment should pass stencil test ,  func(frag.color , (1 && 0xFF))
        glStencilFunc(GL_ALWAYS, 1, 0xFF);
        // update stencil buffer, parameter: sfail stencil fail, dpfail depth fatil, dppass both pass
        //这里sfail dpfail都要设置成keep，只让渲染出来的像素改变stencil buffer
        //避免未通过测试的像素覆盖已经被设置成1的stencil buffer unit
        ...
        // outline draw config
        //If you want to be creative you could even give the borders a more natural look with the help of post-processing filters like Gaussian Blur.
