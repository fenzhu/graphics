...
float skyboxVertices[] = {
    ...
    -1.0f, -1.0f, 1.0f,
    1.0f, -1.0f, 1.0f};
unsigned int cubeVAO, cubeVBO, skyboxVAO;
unsigned int planeVAO, planeVBO, skyboxVBO;
...
int main(int argc, char *argv[])
{
    ...
    Shader skyboxShader = Shader("E:/Glitter/Glitter/Shaders/cubemap.vert",
                                 "E:/Glitter/Glitter/Shaders/cubemap.frag");
