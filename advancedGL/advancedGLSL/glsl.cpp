...
int main(int argc, char *argv[])
{
    ...
    // parameter: target, binding point index, offset, size
    // bind to binding point
    glBindBufferRange(GL_UNIFORM_BUFFER, 0, uboBlock, 0, 2 * sizeof(glm::mat4));

    // build and compile shader
    Shader cubeShader = Shader("E:/Glitter/Glitter/Shaders/glsl.vert",
                               "E:/Glitter/Glitter/Shaders/glsl.frag");
    cubeShader.setInt("skybox", 0);

    Shader skyboxShader = Shader("E:/Glitter/Glitter/Shaders/glsl.vert",
                                 "E:/Glitter/Glitter/Shaders/glsl.frag");
    skyboxShader.setInt("skybox", 0);
    blueShader = Shader("E:/Glitter/Glitter/Shaders/glslblue.vert",
                        "E:/Glitter/Glitter/Shaders/glslblue.frag");
